<template>
    <nuc-page-container header-label="Flex 弹性盒子" no-footer>
        <div class="nuc-flexbox-example-view">
            <h3>基础用法</h3>
            <nuc-flexbox>
...
<script>
export default {
    name: 'example-flex-box'
}
</script>

<style scoped lang="stylus">
    .nuc-flexbox-example-view
        padding: 20px
        h3
            font-size: 40px
            line-height: 2
    ...
    .block-1, .block-2
        ...
        animation stripedAnimate 1s linear 0s infinite
        animation-delay 0
        color: #fff;
        text-align center
